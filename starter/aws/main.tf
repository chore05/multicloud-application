...
[
  {
    "image": "docker.io/chore05/aws_app:1.0",
    "cpu": 1024,
    "memory": 2048,
    "name": "udacity-app",
    "networkMode": "awsvpc",
    "environment": [
      {
        ...
        "value": "udacity-michalchorev-azure-sql"
      },
      {
        "name": "AZURE_DOTNET_APP",
        "value": "udacity-michalchorev-azure-dotnet-app"
      }
    ],
    "portMappings": [
      {
...
resource "aws_s3_bucket" "bucket" {
  bucket = "udacity-michalchorev-aws-s3-bucket"
  acl    = "private"
  tags   = local.tags
}

resource "aws_dynamodb_table" "dynamodb_table" {
  name           = "udacity-michalchorev-aws-dynamodb"
